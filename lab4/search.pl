...
/*Move one missionary*/
child([[M1, C1], [M2, C2]], [[M1n, C1], [M2n, C2]]) :-
  M1 > 0,
  M1n is M1 - 1,
  M2n is M2 + 1,
  survivable([[M1n, C1], [M2n, C2]]).
/*Move two missionaries, retrieve cannibal*/
child([[M1, C1], [M2, C2]], [[M1n, C1n], [M2n, C2n]]) :-
  M1 > 1,
  C2 > 0,
  M1n is M1 - 2,
  M2n is M2 + 2,
...
/*Move two missionaries, last move*/
child([[0, C1], [M2, C2]], [[0, 0], [M2, C2n]]) :-
  \+ dif(M1, 2),
  M1n is M1 - 2,
  M2n is M2 + 2,
  survivable([[0, 0], [M2n, C2]]).
/*Move one cannibal*/
child([[M1, C1], [M2, C2]], [[M1, C1n], [M2, C2n]]) :-
  C1 > 0,
  C1n is C1 - 1,
  C2n is C2 + 1,
  survivable([[M1, C1n], [M2, C2n]]).
/*Move two cannibals, retrieve missionary*/
child([[M1, C1], [M2, C2]], [[M1n, C1n], [M2n, C2n]]) :-
  C1 > 1,
  M2 > 0,
  C1n is C1 - 2,
  ...
  M2n is M2 - 1,
  survivable([[M1n, C1n], [M2n, C2n]]).
/*Move two cannibals, last move*/
child([[0, C1], [M2, C2]], [[0, 0], [M2, C2n]]) :-
  \+ dif(C1, 2),
  C1n is C1 - 2,
  C2n is C2 + 2,
  survivable([[0, 0], [M2, C2n]]).
